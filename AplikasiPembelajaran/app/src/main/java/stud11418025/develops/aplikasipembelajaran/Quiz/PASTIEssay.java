...
public class PASTIEssay extends AppCompatActivity {
    ...
    PASTISoalEssay essay = new PASTISoalEssay();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pastiessay);
    ...
    public void setKonten(){
        ...
        if(x >= arr){
            ...
            Intent i = new Intent(PASTIEssay.this, HasilSkoringPasti.class);
