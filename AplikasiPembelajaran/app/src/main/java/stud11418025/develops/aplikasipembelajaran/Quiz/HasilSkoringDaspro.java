...
public class HasilSkoringDaspro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hasilskoringdaspro);
        ...
        mbtnMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(HasilSkoringDaspro.this, Home.class);
                startActivity(i);
            }
        });
    }
