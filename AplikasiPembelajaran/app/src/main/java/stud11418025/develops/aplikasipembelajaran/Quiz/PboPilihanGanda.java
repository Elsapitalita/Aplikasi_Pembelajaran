...
public class PboPilihanGanda extends AppCompatActivity {
    ...
    SoalPBOPilihanGanda soalPG = new SoalPBOPilihanGanda();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pbo_pilihanganda);
    ...
    public void setKonten(){
        ...
        if(x >= arr){ //jika nilai x melebihi nilai arr(panjang array) maka akan pindah activity (kuis selesai)
            ...
            Intent i = new Intent(PboPilihanGanda.this, HasilSkoringPbo.class);
