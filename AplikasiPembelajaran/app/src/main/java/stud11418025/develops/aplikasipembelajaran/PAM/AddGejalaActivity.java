...
public class AddGejalaActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if (getIntent().hasExtra("id")) {
                    if (0 != Gejala.length()) {
                        ...
                        Toast.makeText(AddGejalaActivity.this, "Silahkan masukkan judul materi.", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    if (0 != Gejala.length() ) {
                        Gejala u = new Gejala();
                        ...
                        Toast.makeText(AddGejalaActivity.this, "Silahkan masukkan detail materi.", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    static class AddGejala extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Toast.makeText(c.get(), "materi PAM added successfully!", Toast.LENGTH_SHORT).show();
    ...
    static class UpdateGejala extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            super.onPostExecute(aVoid);
            Toast.makeText(c.get(), "materi PAM updated successfully!", Toast.LENGTH_SHORT).show();
            ((Activity) c.get()).finish();
        }
    }
