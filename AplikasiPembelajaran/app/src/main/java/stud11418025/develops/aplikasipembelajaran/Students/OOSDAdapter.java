...
public class OOSDAdapter extends RecyclerView.Adapter<OOSDAdapter.GridItemViewHolder> {
    ...
    public OOSDAdapter(Context c, List gejalaList) {
        this.c = c;
    ...
    public GridItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_oosdstud, parent, false);
