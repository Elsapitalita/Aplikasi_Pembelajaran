...
public class OosdPilihanGanda extends AppCompatActivity {
    ...
    SoalOOSDPilihanGanda soalPG = new SoalOOSDPilihanGanda();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_oosd_pilihanganda);
    ...
    public void setKonten(){
        ...
        if(x >= arr){ //jika nilai x melebihi nilai arr(panjang array) maka akan pindah activity (kuis selesai)
            ...
            Intent i = new Intent(OosdPilihanGanda.this, HasilSkoringOosd.class);
