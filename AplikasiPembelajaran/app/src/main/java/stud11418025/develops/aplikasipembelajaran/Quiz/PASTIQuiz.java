...
public class PASTIQuiz extends AppCompatActivity {
    Button mlinePilGan,mLineEssay;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pasti_quiz);
        ...
        mlinePilGan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(PASTIQuiz.this, PastiPilihanGanda.class);
        ...
        mLineEssay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(PASTIQuiz.this, PASTIEssay.class);
                startActivity(i);
            }
        });
