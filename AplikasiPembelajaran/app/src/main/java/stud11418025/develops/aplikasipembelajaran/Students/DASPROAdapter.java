...
public class DASPROAdapter extends RecyclerView.Adapter<DASPROAdapter.GridItemViewHolder> {
    ...
    public DASPROAdapter(Context c, List gejalaList) {
        this.c = c;
    ...
    public GridItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_dasprostud, parent, false);
