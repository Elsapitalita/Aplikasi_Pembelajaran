...
public class PASTI extends AppCompatActivity {
    private RecyclerView rvPASTI;
    private FloatingActionButton fabAddPASTI;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvPASTI = findViewById(R.id.rv_judul);
        fabAddPASTI = findViewById(R.id.fab_add_gejala);

        LinearLayoutManager llm = new LinearLayoutManager(PASTI.this);
        rvPASTI.setLayoutManager(llm);

        fabAddPASTI.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(PASTI.this, AddPASTIActivity.class);
                startActivity(i);
            }
        });
    }
    ...
    protected void onResume() {
        ...
        new GetAllGejala(PASTI.this).execute();
    }
