...
public class HasilSkoringPasti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hasilskoringpasti);
        ...
        mbtnMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(HasilSkoringPasti.this, Home.class);
                startActivity(i);
            }
        });
    }
