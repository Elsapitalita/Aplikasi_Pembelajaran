...
public class PastiPilihanGanda extends AppCompatActivity {
    ...
    SoalPASTIPilihanGanda soalPG = new SoalPASTIPilihanGanda();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pasti_pilihanganda);
    ...
    public void setKonten(){
        ...
        if(x >= arr){ //jika nilai x melebihi nilai arr(panjang array) maka akan pindah activity (kuis selesai)
            ...
            Intent i = new Intent(PastiPilihanGanda.this, HasilSkoringPasti.class);
