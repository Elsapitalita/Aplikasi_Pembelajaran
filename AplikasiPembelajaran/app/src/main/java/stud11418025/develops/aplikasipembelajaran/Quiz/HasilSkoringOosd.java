...
public class HasilSkoringOosd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hasilskoringoosd);
        ...
        mbtnMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(HasilSkoringOosd.this, Home.class);
                startActivity(i);
            }
        });
    }
