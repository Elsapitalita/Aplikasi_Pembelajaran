...
public class HasilSkoringPam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hasilskoringpam);
        ...
        mbtnMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(HasilSkoringPam.this, Home.class);
                startActivity(i);
            }
        });
    }
