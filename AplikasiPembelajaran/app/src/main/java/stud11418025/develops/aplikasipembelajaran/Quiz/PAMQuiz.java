...
public class PAMQuiz extends AppCompatActivity {
    Button mlinePilGan,mLineEssay;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pam_quiz);
        ...
        mlinePilGan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(PAMQuiz.this, PamPilihanGanda.class);
        ...
        mLineEssay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(PAMQuiz.this, PAMEssay.class);
                startActivity(i);
            }
        });
