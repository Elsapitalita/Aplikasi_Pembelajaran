...
public class PBOQuiz extends AppCompatActivity {
    Button mlinePilGan,mLineEssay;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pbo_quiz);
        ...
        mlinePilGan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(PBOQuiz.this, PboPilihanGanda.class);
        ...
        mLineEssay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(PBOQuiz.this, PBOEssay.class);
                startActivity(i);
            }
        });
