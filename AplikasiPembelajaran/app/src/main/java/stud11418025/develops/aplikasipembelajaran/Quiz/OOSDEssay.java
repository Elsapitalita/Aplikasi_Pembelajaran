...
public class OOSDEssay extends AppCompatActivity {
    ...
    OOSDSoalEssay essay = new OOSDSoalEssay();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_oosdessay);
    ...
    public void setKonten(){
        ...
        if(x >= arr){
            ...
            Intent i = new Intent(OOSDEssay.this, HasilSkoringOosd.class);
