...
public class PamPilihanGanda extends AppCompatActivity {
    ...
    SoalPAMPilihanGanda soalPG = new SoalPAMPilihanGanda();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pam_pilihanganda);
    ...
    public void setKonten(){
        ...
        if(x >= arr){ //jika nilai x melebihi nilai arr(panjang array) maka akan pindah activity (kuis selesai)
            ...
            Intent i = new Intent(PamPilihanGanda.this, HasilSkoringPam.class);
