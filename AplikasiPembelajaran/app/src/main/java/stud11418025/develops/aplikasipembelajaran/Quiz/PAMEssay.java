...
public class PAMEssay extends AppCompatActivity {
    ...
    PBOSoalEssay essay = new PBOSoalEssay();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pamessay);
    ...
    public void setKonten(){
        ...
        if(x >= arr){
            ...
            Intent i = new Intent(PAMEssay.this, HasilSkoringPam.class);
