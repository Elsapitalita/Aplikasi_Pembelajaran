...
public class PAMAdapter extends RecyclerView.Adapter<PAMAdapter.GridItemViewHolder> {
    ...
    public PAMAdapter(Context c, List gejalaList) {
        this.c = c;
    ...
    public GridItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_pamstud, parent, false);
