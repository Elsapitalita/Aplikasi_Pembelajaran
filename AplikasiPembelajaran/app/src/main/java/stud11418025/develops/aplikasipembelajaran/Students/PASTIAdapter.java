...
public class PASTIAdapter extends RecyclerView.Adapter<PASTIAdapter.GridItemViewHolder> {
    ...
    public PASTIAdapter(Context c, List gejalaList) {
        this.c = c;
    ...
    public GridItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_pastistud, parent, false);
